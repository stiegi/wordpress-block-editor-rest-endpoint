...
class BlockEditorRestEndpoint_OptionsManager {
    ...
    public function settingsPage() {
        if (!current_user_can('manage_options')) {
            wp_die(__('You do not have sufficient permissions to access this page.', 'block-editor-rest-endpoint'));
        }
        ...
        ?>
        <div class="wrap">
            <h2><?php _e('System Settings', 'block-editor-rest-endpoint'); ?></h2>
            <table cellspacing="1" cellpadding="2"><tbody>
            <tr><td><?php _e('System', 'block-editor-rest-endpoint'); ?></td><td><?php echo php_uname(); ?></td></tr>
            <tr><td><?php _e('PHP Version', 'block-editor-rest-endpoint'); ?></td>
                <td><?php echo phpversion(); ?>
                <?php
                if (version_compare('5.2', phpversion()) > 0) {
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    _e('(WARNING: This plugin may not work properly with versions earlier than PHP 5.2)', 'block-editor-rest-endpoint');
                    echo '</span>';
                }
                ?>
                </td>
            </tr>
            <tr><td><?php _e('MySQL Version', 'block-editor-rest-endpoint'); ?></td>
                <td><?php echo $this->getMySqlVersion() ?>
                    <?php
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    if (version_compare('5.0', $this->getMySqlVersion()) > 0) {
                        _e('(WARNING: This plugin may not work properly with versions earlier than MySQL 5.0)', 'block-editor-rest-endpoint');
                    }
                    echo '</span>';
                    ?>
                </td>
            ...
            <h2><?php echo $this->getPluginDisplayName(); echo ' '; _e('Settings', 'block-editor-rest-endpoint'); ?></h2>
            ...
            <?php settings_fields($settingsGroup); ?>
                ...
                <p class="submit">
                    <input type="submit" class="button-primary"
                           value="<?php _e('Save Changes', 'block-editor-rest-endpoint') ?>"/>
                </p>
            </form>
        </div>
        <?php
    ...
    protected function getOptionValueI18nString($optionValue) {
        switch ($optionValue) {
            case 'true':
                return __('true', 'block-editor-rest-endpoint');
            case 'false':
                return __('false', 'block-editor-rest-endpoint');

            case 'Administrator':
                return __('Administrator', 'block-editor-rest-endpoint');
            case 'Editor':
                return __('Editor', 'block-editor-rest-endpoint');
            case 'Author':
                return __('Author', 'block-editor-rest-endpoint');
            case 'Contributor':
                return __('Contributor', 'block-editor-rest-endpoint');
            case 'Subscriber':
                return __('Subscriber', 'block-editor-rest-endpoint');
            case 'Anyone':
                return __('Anyone', 'block-editor-rest-endpoint');
        }
        return $optionValue;
    }
